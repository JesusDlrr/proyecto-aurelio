    ...
    return (
        <>
            ...
            <div className="h-screen w-screen bg-gray-400 p-10 grid grid-cols-4 grid-rows-4 gap-3 m-auto">
                ...
                {/* Quick Thought */}
                <div className="bg-white text-center text-xl rounded-lg col-span-2 h-10">
                    <textarea placeholder="Quick thought..." className="bg-white w-full rounded-lg shadow border-t-2 p-4 resize-none h-16" onChange={(e) => { setPostMessage(e.target.value) }} />
                ...
                <Suggestions />
                {/* Feed */}
                <div className="bg-gray-400 text-black text-center text-3xl rounded-lg col-span-2 sm:row-span-2 md:row-span-5 -mt-24">
                    {posts.map((post) => {
                        return (<>
