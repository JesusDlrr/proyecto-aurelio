    ...
    return (
        <>
            <div className="text-xl rounded-lg col-span-2">
                <textarea placeholder="Quick thought..." value={post_message} className="bg-white w-full rounded-lg shadow border-t-2 p-4 resize-none" onChange={(e) => { setPostMessage(e.target.value) }} />
